              ...
              <motion.div className="w-full">
                <div className="w-full grid gap-[10px] place-content-center">
                  <motion.div
                    ...
                    className="w-full h-full min-w-[20dvw] min-h-[10vh] max-w-[100dvw] max-h-[25vh] grid row-[2] row-start-auto text-center place-items-center shadow-[0_10px_30px_rgba(0,0,0,0.35)] backdrop-blur-[6px] backdrop-saturate-[120%]   grid z-0 text-[white] m-auto rounded-[10px] "
                  >
